...
- 全局范围：Day 1 - Day 6
- 当前主题：从最小二乘、梯度下降到 MLP 与 Backpropagation
- 当前目标：完成第一性原理推导、最小可运行代码和可公开展示的文档沉淀

## Goals

- 建立 `Day N` 节奏下的第一周学习与文档结构。
- 理解最小二乘和梯度下降的目标函数、梯度形式与优化直觉。
- 用纯 NumPy 实现线性回归的闭式解与梯度下降训练流程。
- 为后续 MLP/backprop 打下符号、shape 和推导风格基础。
